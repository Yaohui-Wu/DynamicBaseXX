* This is an  source code of encryption and decryption algorithm based on Base64 (base32, base16) encoding algorithm, only changing it from static to dynamic.
